...
QT_MOC_LITERAL(1, 13, 11), // "viewImage_1"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 7), // "cv::Mat"
QT_MOC_LITERAL(4, 34, 3) // "mat"

    },
    "XVideoThread\0viewImage_1\0\0cv::Mat\0mat"
};
...
void XVideoThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->viewImage_1((*reinterpret_cast< const cv::Mat(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (XVideoThread::*_t)(const cv::Mat & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&XVideoThread::viewImage_1)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void XVideoThread::viewImage_1(const cv::Mat & _t1)
{
